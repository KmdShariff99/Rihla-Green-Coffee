...
export const metadata:Metadata={metadataBase:new URL("https://www.rihlaglobal.com"),title:{default:"Indian Green Coffee Exporter | Rihla Global",template:"%s | Rihla Global"},description:"Indian green coffee exporter supplying Arabica, Robusta and specialty grades from Chikkamagalur and Kodagu.",icons:{icon:[{url:"/favicon.png",type:"image/png"}],apple:"/favicon.png"},alternates:{canonical:"/"},openGraph:{type:"website",siteName:"Rihla Global",images:[{url:"/rihlaglobal-logo.png",width:1000,height:1000,alt:"RGE Rihla Global logo"}]},twitter:{card:"summary_large_image"}};
