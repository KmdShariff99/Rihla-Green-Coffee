...
export function OrganizationJsonLd(){
  const data={"@context":"https://schema.org","@type":"Organization",name:"Rihla Global",url:siteUrl,email:"exports@rihlaglobal.com",address:{"@type":"PostalAddress",addressLocality:"Bengaluru",addressCountry:"IN"},sameAs:["https://api.whatsapp.com/send?phone=919398540256"],keywords:"Indian green coffee exporter, Chikmagalur coffee, Coorg coffee"};
